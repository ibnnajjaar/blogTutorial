<div class="card">
    <div class="card-header">
        {{ Route::is('categories.edit') ? 'Update' : 'Create New' }} Category
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    @php
                        $selected_name = isset($category) ? $category->name : old('name');
                    @endphp
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    @php
                        $selected_slug = isset($category) ? $category->slug : old('slug');
                    @endphp
    ...
    <div class="card-footer">
        <div class="form-group">
            {!! Form::submit(Route::is('categories.edit') ? 'Update Category' : 'Save Category', ['class' => 'btn btn-sm btn-success']) !!}
        </div>
    </div>
</div>
