...
<tr>
    ...
    <td>{{ $tag->slug }}</td>
    <td>
        {!! Form::open(['action' => ['Admin\TagController@destroy', $tag], 'method' => 'DELETE']) !!}
        <a class="action-icons" href="{{ action('Admin\TagController@show', $tag) }}">
        ...
        <a class="action-icons" href="{{ action('Admin\TagController@edit', $tag) }}">
